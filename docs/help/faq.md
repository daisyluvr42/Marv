---
summary: "Frequently asked questions about Marv setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Marv?](#whats-the-recommended-way-to-install-and-set-up-marv)
  ...
  - [I can't access (SSL error). What now?](#i-cant-access-docsmarvai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or marv not recognized](#windows-install-says-git-not-found-or-marv-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Marv on Linux?](#how-do-i-install-marv-on-linux)
  - [How do I install Marv on a VPS?](#how-do-i-install-marv-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Marv to update itself?](#can-i-ask-marv-to-update-itself)
  ...
  - [If I buy a Mac mini to run Marv, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-marv-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Marv instances?](#can-multiple-people-use-one-whatsapp-number-with-different-marv-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Marv on a dedicated machine?](#how-important-is-it-to-run-marv-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Marv in a VM and what are the requirements](#can-i-run-marv-in-a-vm-and-what-are-the-requirements)
- [What is Marv?](#what-is-marv)
  - [What is Marv, in one paragraph?](#what-is-marv-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Marv](#what-are-the-top-five-everyday-use-cases-for-marv)
  - [Can Marv help with lead gen outreach ads and blogs for a SaaS](#can-marv-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Marv run tasks on a schedule or continuously in the background?](#can-marv-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Marv saved locally?](#is-all-data-used-with-marv-saved-locally)
  - [Where does Marv store its data?](#where-does-marv-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Marv?](#how-do-i-completely-uninstall-marv)
...
- [Config basics](#config-basics)
  ...
  - [Can the Marv browser run headless?](#can-the-marv-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Marv instances talk to each other (local + VPS)?](#can-two-marv-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Marv load environment variables?](#how-does-marv-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Marv instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-marv-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Marv but keep it installed?](#how-do-i-completely-reset-marv-but-keep-it-installed)
  ...
  - [Why doesn't Marv reply in a group?](#why-doesnt-marv-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Marv, Flawd, and Krill use for models?](#what-do-marv-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `marv gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-marv-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `marv gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-marv-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Marv in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-marv-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Marv?](#i-closed-my-terminal-on-windows-how-do-i-restart-marv)
  ...
  - [ELI5: `marv gateway restart` vs `marv gateway`](#eli5-marv-gateway-restart-vs-marv-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Marv to inbound DMs?](#is-it-safe-to-expose-marv-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/marv/marv-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   marv health --json
   marv health --verbose   # shows the target URL + config path on errors
   ```
...
This installs Marv **from a git checkout**, so the agent can read the code + docs and
...
- `marv status`: quick snapshot of gateway/agent health + basic config.
- `marv models status`: checks provider auth + model availability.
- `marv doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `marv status --all`, `marv logs --follow`,
`marv gateway status`, `marv health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Marv
...
The wizard can also build UI assets automatically. After onboarding, you typically run the Gateway on port **4242**.
...
If you don't have a global install yet, run it via `pnpm marv onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `MARV_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `marv config get gateway.auth.token` (or generate one: `marv doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `marv gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `marv gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:4242/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 4242:127.0.0.1:4242 user@host` then open `http://127.0.0.1:4242/` and paste the token in Control UI settings.
...
1. Install Marv on the new machine.
2. Copy `$MARV_STATE_DIR` (default: `~/.marv`) from the old machine.
3. Copy your workspace (default: `~/.marv/workspace`).
4. Run `marv doctor` and restart the Gateway service.
...
under `~/.marv/` (for example `~/.marv/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-marv-store-its-data),
...
### I cant access SSL error What now

Some Comcast/Xfinity connections incorrectly block `via Xfinity
Advanced Security. Disable it or allowlist`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsmarvai-shows-an-ssl-error-comcastxfinity).
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://raw.githubusercontent.com/daisyluvr42/Marv/main/install/install.sh | bash -s -- --beta
```
...
[https://raw.githubusercontent.com/daisyluvr42/Marv/main/install/install.ps1](https://raw.githubusercontent.com/daisyluvr42/Marv/main/install/install.ps1)
...
```bash
curl -fsSL https://raw.githubusercontent.com/daisyluvr42/Marv/main/install/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://raw.githubusercontent.com/daisyluvr42/Marv/main/install/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://raw.githubusercontent.com/daisyluvr42/Marv/main/install/install.sh | bash -s -- --install-method git --verbose
```
...
### Windows install says git not found or marv not recognized
...
**2) marv is not recognized after install**
...
### How do I install Marv on Linux
...
### How do I install Marv on a VPS
...
### Can I ask Marv to update itself
...
marv update --tag <dist-tag|version>
...
`marv onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Marv with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `marv models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `marv models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `marv models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Marv no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Marv can keep replying while a provider is rate-limited.
...
Marv supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Marv fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `marv.json`.

Steps:

1. Enable the plugin: `marv plugins enable google-gemini-cli-auth`
2. Login: `marv models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Marv needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Marv runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Marv can I connect it to my MacBook Pro
...
- Use `marv nodes status` / `marv nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but Marv authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `marv logs --follow` and read `from.id`.
...
If you run Marv via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Marv code install. Your state
(`~/.marv`) and workspace (`~/.marv/workspace`) stay untouched.
...
**Marv-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Marv on a dedicated machine
...
Marv is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Marv in a VM and what are the requirements
...
### What is Marv in one paragraph

Marv is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Marv is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Marv
...
### Can Marv help with lead gen outreach ads and blogs for a SaaS
...
Marv draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Marv is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Marv when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.marv/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.marv/marv.json`). Precedence is `<workspace>/skills` > `~/.marv/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.marv/marv.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.marv/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Marv treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `MARV_SKIP_CRON` is not set.
...
```bash
marv cron run <jobId> --force
marv cron runs --id <jobId> --limit 50
```
...
### Can Marv run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.marv.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-marv-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Marv can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.marv/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "marv": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Marv workspace); Marv treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.marv/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `MARV_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `MARV_DOCKER_APT_PACKAGES`.
...
Marv memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Marv also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Marv auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Marv
prefers `local`.
...
### Is all data used with Marv saved locally

No - **Marv's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.marv` + your workspace directory).
...
### Where does Marv store its data

Everything lives under `$MARV_STATE_DIR` (default: `~/.marv`):

| Path                                                        | Purpose                                                      |
| ----------------------------------------------------------- | ------------------------------------------------------------ |
| `$MARV_STATE_DIR/marv.json`                                 | Main config (JSON5)                                          |
| `$MARV_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$MARV_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$MARV_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$MARV_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$MARV_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$MARV_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$MARV_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.marv/agent/*` (migrated by `marv doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.marv/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.marv`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.marv`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.marv/skills`).

Default workspace is `~/.marv/workspace`, configurable via:
...
Do **not** commit anything under `~/.marv` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Marv
...
Marv reads an optional **JSON5** config from `$MARV_CONFIG_PATH` (default: `~/.marv/marv.json`):

```
$MARV_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.marv/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `MARV_GATEWAY_TOKEN`).
...
Marv enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `marv doctor --generate-gateway-token`.
...
key. **Recommended:** run `marv configure --section web` to store it in
...
- Daemons read env vars from `~/.marv/.env` (or the service environment).
...
- Gateway is running: `marv gateway status`
- Gateway health: `marv status`
- Channel health: `marv channels status`
...
### Can two Marv instances talk to each other local VPS
...
`marv agent --message ... --deliver`, targeting a chat where the other bot
...
- Restore from backup (git or a copied `~/.marv/marv.json`).
- If you have no backup, re-run `marv doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `marv config set` for small changes.
- Use `marv configure` for interactive edits.
...
4. **Use the tailnet hostname**
   ...
   - Gateway WS: `ws://your-vps.tailnet-xxxx.ts.net:4242`

If you want the Control UI without SSH, use Tailscale Serve on the VPS:

```bash
marv gateway --tailscale serve
```
...
### How does Marv load environment variables

Marv reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.marv/.env` (aka `$MARV_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.marv/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`MARV_LOAD_SHELL_ENV=1`, `MARV_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`marv models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Marv won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.marv/.env`:
...
### How do I completely reset Marv but keep it installed
...
```bash
marv reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `MARV_PROFILE`), reset each state dir (defaults are `~/.marv-<profile>`).
- Dev reset: `marv gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
No. Marv runs on **your own account**, so if you're in the group, Marv can see it.
...
```bash
marv directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Marv reply in a group
...
- Use `marv doctor` to spot stray workspaces and profile mismatches.
...
### What do Marv, Flawd, and Krill use for models

- **Marv + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. Marv ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.marv/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.marv/agent/*` (migrated by `marv doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.marv/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `marv models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `marv models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `marv models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.marv/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    marv models auth order clear --provider anthropic
    ```
...
Fix: Marv now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Marv uses provider-prefixed IDs like:
...
Marv may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `marv models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
marv models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
marv models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
marv models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
marv models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > MARV_GATEWAY_PORT > gateway.port > default 4242
```

### Why does marv gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `marv gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does marv gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `MARV_STATE_DIR` mismatch).

Fix:

```bash
marv gateway install --force
```
...
Marv enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:4242`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `marv gateway --port <port>`.

### How do I run Marv in remote mode client connects to a Gateway elsewhere
...
- `marv gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `marv.control.settings.v1`.

Fix:

- Fastest: `marv dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `marv doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 4242:127.0.0.1:4242 user@host` then open `http://127.0.0.1:4242/`.
- Set `gateway.auth.token` (or `MARV_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `marv status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `MARV_CONFIG_PATH` (per-instance config)
- `MARV_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `marv --profile <name> …` per instance (auto-creates `~/.marv-<name>`).
...
1. Use the WS URL: `ws://<host>:4242` (or `wss://...` if HTTPS).
...
```
marv tui --url ws://<host>:4242 --token <token>
```
...
- macOS: `$MARV_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.marv/logs/...`; profiles use `~/.marv-<profile>/logs/...`)
- Linux: `journalctl --user -u marv-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Marv Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `marv gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Marv
...
1. Is the Gateway running? `marv gateway status`
2. Is the Gateway healthy? `marv status`
3. Does the UI have the right token? `marv dashboard`
...
### ELI5 marv gateway restart vs marv gateway

- `marv gateway restart`: restarts the **background service** (launchd/systemd).
- `marv gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `marv gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Marv assistant setup](/start/marv) and [Agent send](/tools/agent-send).

CLI sending:

```bash
marv message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Marv to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `marv pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `marv pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `marv doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Marv only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
marv pairing approve whatsapp <code>
```

List pending requests:

```bash
marv pairing list whatsapp
```
...
Marv blocks **cross-provider** messaging by default. If a tool call is bound
