---
summary: "First-run onboarding flow for Marv (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Marv">
...
<Step title="CLI">
  ...
  The app can install the global `marv` CLI via npm/pnpm so terminal
