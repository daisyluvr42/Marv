---
summary: "Hubs that link to every Marv doc"
read_when:
...
<Note>
If you are new to Marv, start with [Getting Started](/start/getting-started).
</Note>
...
- [Wizard](/start/wizard)
- [Setup](/start/setup)
- [Dashboard (local Gateway)](http://127.0.0.1:4242/)
- [Help](/help)
- [Docs directory](/start/docs-directory)
- [Configuration](/gateway/configuration)
- [Configuration examples](/gateway/configuration-examples)
- [Marv assistant](/start/marv)
