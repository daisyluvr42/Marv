---
summary: "Overview of Marv onboarding options and flows"
read_when:
...
Marv supports multiple onboarding paths depending on where the Gateway runs
...
- [`marv onboard` command](/cli/onboard)

## macOS app onboarding

Use the Marv app when you want a fully guided setup on macOS. Docs:
