...
read_when:
  - You are building a Marv plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (marv.plugin.json)

Every plugin **must** ship a `marv.plugin.json` file in the **plugin root**.
Marv uses this manifest to validate configuration **without executing plugin
