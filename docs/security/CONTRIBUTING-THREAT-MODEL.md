# Contributing to the Marv Threat Model

Thanks for helping make Marv more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.

## Ways to Contribute

### Add a Threat

Spotted an attack vector or risk we haven't covered? Open an issue on [marv/trust](https://github.com/daisyluvr42/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.

**Helpful to include (but not required):**

- The attack scenario and how it could be exploited
- Which parts of Marv are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
- How severe you think it is (low / medium / high / critical)
- Any links to related research, CVEs, or real-world examples

We'll handle the ATLAS mapping, threat IDs, and risk assessment during review. If you want to include those details, great - but it's not expected.

> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, use [Marv Security Advisories](https://github.com/daisyluvr42/Marv/security/advisories/new) for a private report.
...
- [Marv Threat Model](./THREAT-MODEL-ATLAS.md)

## Contact

- **Security vulnerabilities:** Use [Marv Security Advisories](https://github.com/daisyluvr42/Marv/security/advisories/new)
- **Threat model questions:** Open an issue on [marv/trust](https://github.com/daisyluvr42/trust/issues)
- **General chat:** Discord #security channel

## Recognition

Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Marv security hall of fame for significant contributions.
