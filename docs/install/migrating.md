---
summary: "Move (migrate) a Marv install from one machine to another"
read_when:
  - You are moving Marv to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
title: "Migration Guide"
---

# Migrating Marv to a new machine

This guide migrates a Marv Gateway from one machine to another **without redoing onboarding**.
...
- Gateway configuration (`marv.json`)
...
### Footgun: copying only `marv.json`
...
- `marv status` shows the gateway running
