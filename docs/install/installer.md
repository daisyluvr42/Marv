...
<Tabs>
  <Tab title="install.sh">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install.sh | bash
    ```

    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install.sh | bash -s -- --help
    ```

  </Tab>
  <Tab title="install-cli.sh">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install-cli.sh | bash
    ```

    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install-cli.sh | bash -s -- --help
    ```
  ...
  <Tab title="install.ps1">
    ...
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://marv.bot/install.ps1))) -Tag beta -NoOnboard -DryRun
    ```
...
<Tabs>
  ...
  <Tab title="Skip onboarding">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install.sh | bash -s -- --no-onboard
    ```
  </Tab>
  ...
  <Tab title="Dry run">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install.sh | bash -s -- --dry-run
    ```
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Custom prefix + version">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install-cli.sh | bash -s -- --prefix /opt/marv --version latest
    ```
  </Tab>
  <Tab title="Automation JSON output">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install-cli.sh | bash -s -- --json --prefix /opt/marv
    ```
  </Tab>
  <Tab title="Run onboarding">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install-cli.sh | bash -s -- --onboard
    ```
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Git install">
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://marv.bot/install.ps1))) -InstallMethod git
    ```
  </Tab>
  <Tab title="Custom git directory">
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://marv.bot/install.ps1))) -InstallMethod git -GitDir "C:\marv"
    ```
  </Tab>
  <Tab title="Dry run">
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://marv.bot/install.ps1))) -DryRun
    ```
  </Tab>
...
<Tabs>
  <Tab title="install.sh (non-interactive npm)">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install.sh | bash -s -- --no-prompt --no-onboard
    ```
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="sharp/libvips issues">
    ...
    ```bash
    SHARP_IGNORE_GLOBAL_LIBVIPS=0 curl -fsSL --proto '=https' --tlsv1.2 https://marv.bot/install.sh | bash
    ```
