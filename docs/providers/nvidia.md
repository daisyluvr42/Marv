---
summary: "Use NVIDIA's OpenAI-compatible API in Marv"
read_when:
  - You want to use NVIDIA models in Marv
...
marv onboard --auth-choice skip
marv models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
