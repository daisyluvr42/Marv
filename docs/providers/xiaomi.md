---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Marv"
read_when:
  - You want Xiaomi MiMo models in Marv
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Marv uses
