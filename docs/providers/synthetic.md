---
summary: "Use Synthetic's Anthropic-compatible API in Marv"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Marv registers it as the
...
Note: Marv's Anthropic client appends `/v1` to the base URL, so use
