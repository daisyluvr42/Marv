...
You can point Marv at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Marv
...
- [Anthropic provider](/providers/anthropic) - Native Marv integration with Claude setup-token or API keys
