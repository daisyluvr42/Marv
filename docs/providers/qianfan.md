---
summary: "Use Qianfan's unified API to access many models in Marv"
read_when:
...
3. Marv installed on your system
...
4. Copy the API key for use with Marv

## CLI setup

```bash
marv onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Marv Configuration](/gateway/configuration)
