---
title: IRC
description: Connect Marv to IRC channels and direct messages.
---

Use IRC when you want Marv in classic channels (`#room`) and direct messages.
...
Even if a channel is allowed (via `groupPolicy` + `groups`) and the sender is allowed, Marv defaults to **mention-gating** in group contexts.
