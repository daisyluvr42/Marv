...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Marv HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `marv pairing approve slack <code>`.
...
Marv supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Marv falls back to normal delivery for remaining payloads.
