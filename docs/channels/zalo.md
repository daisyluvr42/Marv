...
- Install via CLI: `marv plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `marv plugins install ./extensions/zalo`
   - From npm (if published): `marv plugins install @openclaw/zalo`
...
- Approve via:
  - `marv pairing list zalo`
  - `marv pairing approve zalo <CODE>`
...
- Example: `marv message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `marv channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `marv logs --follow`
