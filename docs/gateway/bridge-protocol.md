...
**Note:** Current Marv builds no longer ship the TCP bridge listener; this document is kept for historical reference.
...
- Legacy default listener port was `4243` (current builds do not start a TCP bridge).
