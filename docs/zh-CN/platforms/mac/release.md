...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/Marv-2026.1.27-beta.1.zip https://raw.githubusercontent.com/marv/marv/main/appcast.xml
```
...
- 确保原始 appcast URL 与内置的订阅源匹配：`https://raw.githubusercontent.com/marv/marv/main/appcast.xml`。
- 完整性检查：
  - `curl -I https://raw.githubusercontent.com/marv/marv/main/appcast.xml` 返回 200。
