...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 Marv 安装
title: Ansible
x-i18n:
...
将 Marv 部署到生产服务器的推荐方式是通过 **[marv-ansible](-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/daisyluvr42/Marv-ansible](-ansible)**
>
> marv-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 或直接运行（然后手动执行 /tmp/marv-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 Marv

Ansible 安装程序设置 Marv 为手动更新。标准更新流程参见[更新](/install/updating)。
...
- [安全架构](-ansible/blob/main/docs/security.md)
- [技术详情](-ansible/blob/main/docs/architecture.md)
- [故障排除指南](-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [marv-ansible](-ansible) — 完整部署指南
