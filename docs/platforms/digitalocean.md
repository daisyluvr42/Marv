---
summary: "Marv on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up Marv on DigitalOcean
  - Looking for cheap VPS hosting for Marv
title: "DigitalOcean"
---

# Marv on DigitalOcean

## Goal

Run a persistent Marv Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
journalctl -u marv --no-pager -n 50
```
