...
ditto -c -k --sequesterRsrc --keepParent dist/Marv.app dist/Marv-2026.2.18.zip

# Optional: also build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/Marv.app dist/Marv-2026.2.18.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/Marv.app.dSYM dist/Marv-2026.2.18.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/Marv-2026.2.18.zip https://raw.githubusercontent.com/marv/marv/main/appcast.xml
```
...
- Upload `Marv-2026.2.18.zip` (and `Marv-2026.2.18.dSYM.zip`) to the GitHub release for tag `v2026.2.18`.
