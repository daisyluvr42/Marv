...
Marv.app no longer bundles Node/Bun or the Gateway runtime. The macOS app
expects an **external** `marv` CLI install, does not spawn the Gateway as a
...
- The CLI can also install it: `marv gateway install`.

Behavior:

- “Marv Active” enables/disables the LaunchAgent.
