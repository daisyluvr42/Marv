...
Nostr DM channel plugin for Marv using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Marv. It enables your bot to:
...
# Configure marv to use local relay
