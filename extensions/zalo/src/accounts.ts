...
function listConfiguredAccountIds(cfg: MarvConfig): string[] {
...
export function listZaloAccountIds(cfg: MarvConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: MarvConfig): string {
...
function resolveAccountConfig(cfg: MarvConfig, accountId: string): ZaloAccountConfig | undefined {
  const accounts = (cfg.channels?.zalo as ZaloConfig | undefined)?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeZaloAccountConfig(cfg: MarvConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: MarvConfig): ResolvedZaloAccount[] {
