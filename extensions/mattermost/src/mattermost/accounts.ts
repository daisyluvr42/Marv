...
export function listMattermostAccountIds(cfg: MarvConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: MarvConfig): string {
...
function mergeMattermostAccountConfig(cfg: MarvConfig, accountId: string): MattermostAccountConfig {
...
export function listEnabledMattermostAccounts(cfg: MarvConfig): ResolvedMattermostAccount[] {
