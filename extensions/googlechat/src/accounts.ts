...
export function listGoogleChatAccountIds(cfg: MarvConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: MarvConfig): string {
...
function mergeGoogleChatAccountConfig(cfg: MarvConfig, accountId: string): GoogleChatAccountConfig {
...
export function listEnabledGoogleChatAccounts(cfg: MarvConfig): ResolvedGoogleChatAccount[] {
