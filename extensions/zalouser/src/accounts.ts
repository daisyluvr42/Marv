...
export function listZalouserAccountIds(cfg: MarvConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: MarvConfig): string {
...
function mergeZalouserAccountConfig(cfg: MarvConfig, accountId: string): ZalouserAccountConfig {
