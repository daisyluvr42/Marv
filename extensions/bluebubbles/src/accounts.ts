...
export function listBlueBubblesAccountIds(cfg: MarvConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: MarvConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: MarvConfig): ResolvedBlueBubblesAccount[] {
