...
final class MarvAppDelegate: NSObject, UIApplicationDelegate {
    private let logger = Logger(subsystem: "ai.marv.ios", category: "Push")
...
struct MarvApp: App {
    ...
    @UIApplicationDelegateAdaptor(MarvAppDelegate.self) private var appDelegate
...
extension MarvApp {
    private static func installUncaughtExceptionLogger() {
        NSLog("Marv: installing uncaught exception handler")
