...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MarvPhotosLatestParams) async throws -> MarvPhotosLatestPayload {
        ...
        return MarvPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MarvPhotoPayload
    {
