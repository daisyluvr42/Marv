...
struct CompanionChatTransport: OpenClawChatTransport, Sendable {
    private static let logger = Logger(subsystem: "ai.marv.ios", category: "chat.transport")
    ...
    func setActiveSessionKey(_ sessionKey: String) async throws {
        // Operator clients already receive chat events without a subscription step.
    }
