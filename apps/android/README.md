## Marv Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_marv-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm marv gateway --port 18789 --verbose
```
