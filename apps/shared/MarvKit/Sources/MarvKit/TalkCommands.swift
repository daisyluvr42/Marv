...
public enum MarvTalkCommand: String, Codable, Sendable {
...
public struct MarvTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MarvTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
