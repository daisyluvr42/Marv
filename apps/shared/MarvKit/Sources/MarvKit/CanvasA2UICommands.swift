...
public enum MarvCanvasA2UICommand: String, Codable, Sendable {
...
public struct MarvCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MarvCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
