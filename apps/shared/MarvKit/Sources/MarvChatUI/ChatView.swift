...
@MainActor
public struct MarvChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MarvChatViewModel
    ...
    private var visibleMessages: [MarvChatMessage] {
        let base: [MarvChatMessage]
    ...
    private func mergeToolResults(in messages: [MarvChatMessage]) -> [MarvChatMessage] {
    ...
    private func isToolResultMessage(_ message: MarvChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: MarvChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MarvChatMessage) -> String {
