...
public typealias MarvPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MarvPlatformImage = UIImage
#endif

public struct MarvChatUsageCost: Codable, Hashable, Sendable {
...
public struct MarvChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MarvChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MarvChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MarvChatMessageContent: Codable, Hashable, Sendable {
...
public struct MarvChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MarvChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MarvChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MarvChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MarvChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MarvChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MarvChatMessageContent].self, forKey: .content) {
...
public struct MarvChatHistoryPayload: Codable, Sendable {
...
public struct MarvSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MarvSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MarvSessionPreviewItem]
}

public struct MarvSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MarvSessionPreviewEntry]

    public init(ts: Int, previews: [MarvSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MarvChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MarvChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MarvAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MarvChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MarvGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MarvPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MarvPlatformImage?
...
public struct MarvChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
