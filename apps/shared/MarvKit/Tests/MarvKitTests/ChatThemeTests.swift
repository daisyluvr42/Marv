...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = MarvChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = MarvChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
