...
struct AboutSettings: View {
        ...
        VStack(spacing: 8) {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://marv.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "MarvBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MarvBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MarvGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MarvGitCommit") as? String) ??
            "unknown"
    }
