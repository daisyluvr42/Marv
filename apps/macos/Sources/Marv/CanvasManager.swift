...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.marv", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Marv/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__marv__/a2ui/").absoluteString + "?platform=macos"
    }
