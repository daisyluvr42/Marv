...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "ai.marv", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "ai.marv", category: "gateway-endpoint")
