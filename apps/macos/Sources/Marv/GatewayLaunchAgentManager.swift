...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "bot.marv", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".marv/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.marvCommand(
            subcommand: "gateway",
