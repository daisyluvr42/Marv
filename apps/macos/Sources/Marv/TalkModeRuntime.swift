...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.marv", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.marv", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MarvChatMessage] = messages.compactMap { item in
