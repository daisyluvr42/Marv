...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.marv", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Marv windows, but below the system’s pop-up menus.
