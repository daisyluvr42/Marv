...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`bot.marv.mac`) even if the shipped
        ...
        isAppBundle: Bool) -> Bool
    {
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "marv.nixMode") { return true }
