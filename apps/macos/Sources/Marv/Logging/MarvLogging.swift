...
enum MarvLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = MarvOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = MarvFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        ...
        let label = MarvLogging.makeLabel(subsystem: subsystem, category: category)
...
struct MarvOSLogHandler: LogHandler {
...
struct MarvFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = MarvLogging.parseLabel(self.label)
