...
struct WideAreaGatewayDiscoveryTests {
    @Test func discoversBeaconFromTailnetDnsSdFallback() {
        setenv("MARV_WIDE_AREA_DOMAIN", "marv.internal", 1)
        let statusJson = """
        {
        ...
        let context = WideAreaGatewayDiscovery.DiscoveryContext(
            ...
            dig: { args, _ in
                ...
                if recordType == "SRV" {
                    return "0 0 18789 steipetacstudio.marv.internal."
                }
                if recordType == "TXT" {
                    return "\"displayName=Peter\\226\\128\\153s Mac Studio (Marv)\" \"gatewayPort=18789\" \"tailnetDns=peters-mac-studio-1.sheep-coho.ts.net\" \"cliPath=/Users/steipete/marv/src/entry.ts\""
                }
                return ""
            })
