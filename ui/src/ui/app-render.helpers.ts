...
import { ChatState, loadChatHistory } from "./controllers/chat.js";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as MarvApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as MarvApp).resetToolStream();
  (state as unknown as MarvApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as MarvApp;
