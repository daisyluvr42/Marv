...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    calendar: "Atividade diária, execuções de cron e sessões em destaque.",
    ...
    projects: "Atividade de sessão, custos e progresso recente em um só lugar.",
    memory: "Pesquise ou navegue pela soul memory sem sair do workspace.",
    documents: "Arquivos recentes do workspace e documentos gerados.",
    ...
    config: "Editar ~/.marv/marv.json com segurança.",
  ...
  overview: {
    ...
    advanced: {
      memoryTitle: "Memória",
      memorySubtitle: "Saúde da Soul Memory e do recall.",
      knowledgeTitle: "Base de Conhecimento",
      knowledgeSubtitle: "Status da indexação dos vaults locais.",
      proactiveTitle: "Proativo",
      proactiveSubtitle: "Estado do buffer de digest e da entrega.",
      loading: "Atualizando status do dashboard...",
      status: "Status",
      totalItems: "Total de Itens",
      archiveEvents: "Eventos de Arquivo",
      autoRecall: "Auto Recall",
      runtimeIngest: "Ingestão em Runtime",
      tiers: "Camadas",
      backend: "Backend",
      citations: "Citações",
      vaults: "Vaults",
      ...
      pending: "Pendentes",
      urgent: "Urgentes",
      lastFlush: "Último Flush",
      digests: "Horários de Digest",
      delivery: "Entrega",
    },
  },
  chat: {
