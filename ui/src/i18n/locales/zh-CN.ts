...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    cron: "安排唤醒和重复的代理运行。",
    projects: "快速查看会话活跃度、成本和近期进展。",
    memory: "在工作区内搜索或浏览 Soul Memory。",
    documents: "查看最近的工作区文件和生成文档。",
    skills: "管理技能可用性和 API 密钥注入。",
    nodes: "配对设备、功能和命令公开。",
    chat: "用于快速干预的直接网关聊天会话。",
    config: "安全地编辑 ~/.marv/marv.json。",
  ...
  overview: {
    ...
    advanced: {
      ...
      proactiveTitle: "主动通知",
      proactiveSubtitle: "digest buffer 与投递状态。",
      loading: "正在刷新 dashboard 状态...",
      status: "状态",
      totalItems: "总条目",
      archiveEvents: "归档事件",
      autoRecall: "自动回忆",
