...
- During `prepare-pr`, use this commit subject format: `fix: <summary> (marv#<PR>) thanks @<pr-author>`.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](/help/submitting-a-pr)) for what we expect from contributors.
