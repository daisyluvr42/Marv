...
- `fix: <summary> (marv#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (marv#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "marv#$pr_number" || { echo "ERROR: commit subject missing marv#$pr_number"; exit 1; }
