...
show_usage() {
    cat << EOF
clawlog - Marv Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Marv logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Marv logs flow through the macOS unified log (subsystem: ai.marv).
