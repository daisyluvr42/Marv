...
# Output:
# - dist/Marv.app
# - dist/Marv-<version>.zip
# - dist/Marv-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Marv-$VERSION.zip"
DMG="$ROOT_DIR/dist/Marv-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Marv-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Marv-$VERSION.dSYM.zip"
