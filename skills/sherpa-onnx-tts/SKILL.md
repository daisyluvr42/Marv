...
1. Download the runtime for your OS (extracts into `~/.marv/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.marv/tools/sherpa-onnx-tts/models`)

Update `~/.marv/marv.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.marv/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.marv/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
