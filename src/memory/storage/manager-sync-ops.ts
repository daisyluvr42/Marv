...
import { onSessionTranscriptUpdate } from "../../core/session/transcript-events.js";
import { createSubsystemLogger } from "../../logging/subsystem.js";
import { resolveUserPath } from "../../utils.js";
import { DEFAULT_GEMINI_EMBEDDING_MODEL } from "../embeddings/embeddings-gemini.js";
import { DEFAULT_OPENAI_EMBEDDING_MODEL } from "../embeddings/embeddings-openai.js";
import { DEFAULT_VOYAGE_EMBEDDING_MODEL } from "../embeddings/embeddings-voyage.js";
import {
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: MarvConfig;
  protected abstract readonly agentId: string;
  protected abstract readonly workspaceDir: string;
  protected abstract readonly settings: ResolvedMemorySearchConfig;
  protected provider: EmbeddingProvider | null = null;
  protected fallbackFrom?: "openai" | "local" | "gemini" | "voyage" | "script";
    ...
    try {
      if (needsFullReindex) {
        if (
          ...
          process.env.MARV_TEST_MEMORY_UNSAFE_REINDEX === "1"
        ) {
