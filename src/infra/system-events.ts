...
function appendSystemEventLedger(params: {
  type: "system_event.enqueue" | "system_event.drain";
  sessionKey: string;
  ...
  try {
    ...
    // Fail-open: system event delivery should continue even when ledger writes fail.
  }
}
