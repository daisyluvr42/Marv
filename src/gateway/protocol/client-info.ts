export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "marv-control-ui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "marv-macos",
  IOS_APP: "marv-ios",
  ANDROID_APP: "marv-android",
  NODE_HOST: "node-host",
  TEST: "test",
...
export function normalizeGatewayClientId(raw?: string | null): GatewayClientId | undefined {
  ...
  return LEGACY_GATEWAY_CLIENT_ID_ALIASES[
    normalized as keyof typeof LEGACY_GATEWAY_CLIENT_ID_ALIASES
  ];
}
