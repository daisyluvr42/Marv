...
export function resolveHooksConfig(cfg: MarvConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: MarvConfig, defaultAgentId: string): Set<string> {
