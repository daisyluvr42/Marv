...
import { parseAudioTag } from "../delivery/audio-tags.js";
import { createBlockReplyCoalescer } from "../delivery/block-coalescer.js";
import { normalizeReplyPayload } from "../delivery/normalize.js";
import { createReplyReferencePlanner } from "../delivery/reference.js";
import {
  extractShortModelName,
  hasTemplateVariables,
  resolveResponsePrefixTemplate,
} from "../delivery/response-prefix-template.js";
import { createTypingSignaler, resolveTypingMode } from "../delivery/typing-mode.js";
import { createTypingController } from "../delivery/typing.js";
import { createStreamingDirectiveAccumulator } from "../directives/streaming.js";
import { matchesMentionWithExplicit } from "../support/mentions.js";
import { SILENT_REPLY_TOKEN } from "../support/tokens.js";
import { createMockTypingController } from "./test-helpers.js";

describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bmarv\b/i];
...
describe("resolveResponsePrefixTemplate", () => {
  ...
  it("handles complex template with all variables", () => {
    ...
    expect(result).toBe("[Marv] anthropic/claude-opus-4-5 (think:high)");
  });
});
