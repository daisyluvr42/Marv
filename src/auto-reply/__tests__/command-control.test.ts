...
import { hasControlCommand, hasInlineCommandTokens } from "../commands/detection.js";
...
describe("resolveCommandAuthorization", () => {
  ...
  describe("commands.allowFrom", () => {
    ...
    function makeWhatsAppContext(senderId: string): TurnContext {
      return {
        Provider: "whatsapp",
        Surface: "whatsapp",
    ...
    function makeDiscordContext(senderId: string, fromOverride?: string): TurnContext {
      return {
        Provider: "discord",
        Surface: "discord",
...
describe("control command parsing", () => {
  ...
  it("ignores telegram commands addressed to other bots", () => {
    ...
    expect(
      hasControlCommand("/help@marv", undefined, {
        botUsername: "marv",
      }),
    ).toBe(true);
  });
