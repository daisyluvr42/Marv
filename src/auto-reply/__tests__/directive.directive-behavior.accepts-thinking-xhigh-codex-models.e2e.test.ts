...
import {
  ...
  sessionStorePath,
  withTempHome,
} from "./directive.directive-behavior.e2e-harness.js";
  ...
  it("rejects /thinking xhigh for non-codex models", async () => {
    await withTempHome(async (home) => {
      ...
      expect(texts).toContain(
        'Thinking level "xhigh" is only supported for openai/gpt-5.4, openai/gpt-5.2, openai-codex/gpt-5.4-codex, openai-codex/gpt-5.3-codex, openai-codex/gpt-5.3-codex-spark, openai-codex/gpt-5.2-codex, openai-codex/gpt-5.1-codex, github-copilot/gpt-5.4-codex, github-copilot/gpt-5.4, github-copilot/gpt-5.2-codex or github-copilot/gpt-5.2.',
      );
    });
  });
