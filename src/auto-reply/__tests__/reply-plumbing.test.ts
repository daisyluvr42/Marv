...
import { applyReplyThreading } from "../delivery/payloads.js";
import { buildThreadingToolContext } from "../execution/utils.js";
import {
  formatRunLabel,
  formatRunStatus,
...
describe("buildThreadingToolContext", () => {
  ...
  it("prefers MessageThreadId for Slack tool threading", () => {
    ...
    const result = buildThreadingToolContext({
      sessionCtx,
      config: { channels: { slack: { replyToMode: "all" } } } as MarvConfig,
      hasRepliedRef: undefined,
    });
