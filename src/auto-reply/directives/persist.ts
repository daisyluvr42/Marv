...
import { resolveProfileOverride } from "./auth.js";
import type { ElevatedLevel, ReasoningLevel } from "./directives.js";
import type { InlineDirectives } from "./parse.js";
import { enqueueModeSwitchEvents } from "./shared.js";
...
export async function persistInlineDirectives(params: {
  ...
  agentCfg: NonNullable<MarvConfig["agents"]>["defaults"] | undefined;
...
export function resolveDefaultModel(params: { cfg: MarvConfig; agentId?: string }): {
  defaultProvider: string;
  defaultModel: string;
  aliasIndex: ModelAliasIndex;
} {
