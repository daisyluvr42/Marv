...
import { buildCommandContext } from "../commands/dispatch.js";
import { listChatCommands, shouldHandleTextCommands } from "../commands/registry.js";
import { listSkillCommandsForWorkspace } from "../commands/skill-commands.js";
import { resolveBlockStreamingChunking } from "../delivery/block-streaming.js";
import type { TypingController } from "../delivery/typing.js";
import { createModelSelectionState, resolveContextTokens } from "../execution/model-selection.js";
import { defaultGroupActivation, resolveGroupRequireMention } from "../inbound/groups.js";
import {
...
import { applyInlineDirectiveOverrides } from "./apply-directives.js";
import { type InlineDirectives, parseInlineDirectives } from "./index.js";
import { formatElevatedUnavailableMessage, resolveElevatedPermissions } from "./reply-elevated.js";
import { stripInlineStatus } from "./reply-inline.js";
import { clearExecInlineDirectives, clearInlineDirectives } from "./utils.js";

type AgentDefaults = NonNullable<MarvConfig["agents"]>["defaults"];
type ExecOverrides = Pick<ExecToolDefaults, "host" | "security" | "ask" | "node">;

function hasPromptImages(ctx: TurnContext): boolean {
  return (
