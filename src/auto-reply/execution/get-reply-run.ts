...
const {
  ...
  auth: { resolveSessionAuthProfileOverride },
} = agents;
...
import { hasControlCommand } from "../commands/detection.js";
import type { buildCommandContext } from "../commands/dispatch.js";
import { applySessionHints } from "../delivery/body.js";
import { routeReply } from "../delivery/route.js";
import { evaluateSmartResponse } from "../delivery/smart-response.js";
import { resolveTypingMode } from "../delivery/typing-mode.js";
import type { TypingController } from "../delivery/typing.js";
import type { InlineDirectives } from "../directives/index.js";
import { buildGroupChatContext, buildGroupIntro, resolveGroupPersona } from "../inbound/groups.js";
import { buildInboundMetaSystemPrompt, buildInboundUserContextPrefix } from "../inbound/meta.js";
import { appendUntrustedContext } from "../inbound/untrusted-context.js";
import { resolveQueueSettings } from "../queue/index.js";
import { BARE_SESSION_RESET_PROMPT } from "../session/reset-prompt.js";
import { ensureSkillSnapshot, prependSystemEvents } from "../session/updates.js";
import { buildInboundMediaNote } from "../support/media-note.js";
...
export async function runPreparedReply(
  ...
  const hasPromptMediaAttachment = Boolean(
    (ctx.MultimodalRouting?.promptMedia ?? ctx.PromptMedia ?? []).length > 0,
  );
  const hasMediaAttachment = Boolean(
    hasPromptMediaAttachment ||
