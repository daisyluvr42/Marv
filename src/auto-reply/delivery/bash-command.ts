...
import {
  ...
  getSession,
  markExited,
} from "../../agents/tools/bash/bash-process-registry.js";
import { createExecTool } from "../../agents/tools/bash/bash-tools.js";
import type { MarvConfig } from "../../core/config/config.js";
import { logVerbose } from "../../globals.js";
import { clampInt } from "../../utils.js";
import { formatElevatedUnavailableMessage } from "../directives/elevated-unavailable.js";
import { stripMentions, stripStructuralPrefixes } from "../support/mentions.js";
...
function resolveForegroundMs(cfg: MarvConfig): number {
...
export async function handleBashChatCommand(params: {
  ...
  if (params.cfg.commands?.bash !== true) {
    return {
      text: "⚠️ bash is disabled. Set commands.bash=true to enable. Docs: /tools/slash-commands#config",
    };
  }
