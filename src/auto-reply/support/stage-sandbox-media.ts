...
import type { TurnContext, SessionTemplateContext } from "./templating.js";
...
export async function stageSandboxMedia(params: {
  ...
  // For remote attachments without sandbox, use ~/.marv/media (not agent workspace for privacy)
