 ...
 */
export async function buildModelsProviderData(cfg: MarvConfig): Promise<ModelsProviderData> {
...
export function registerModelsCommands(registry: CommandRegistry): void {
  registry.register("models", handleModelsCommand);
}
