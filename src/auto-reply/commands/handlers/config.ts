...
import { parseConfigCommand } from "./config-ops.js";
import { parseDebugCommand } from "./debug.js";
...
export function registerConfigCommands(registry: CommandRegistry): void {
  registry.register("config", handleConfigCommand);
  registry.register("debug", handleDebugCommand);
}
