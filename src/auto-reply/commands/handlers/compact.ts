...
import { formatContextUsageShort, formatTokenCount } from "../../support/status.js";
import type { CommandRegistry } from "../command-registry.js";
import type { CommandHandler } from "../handler-types.js";

function extractCompactInstructions(params: {
  rawBody?: string;
  ctx: import("../../support/templating.js").TurnContext;
  cfg: MarvConfig;
  agentId?: string;
  isGroup: boolean;
}): string | undefined {
...
export function registerCompactCommands(registry: CommandRegistry): void {
  registry.register("compact", handleCompactCommand);
}
