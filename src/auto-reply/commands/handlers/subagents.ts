...
import { stopSubagentsForRequester } from "../../support/abort.js";
import {
  formatRunLabel,
  formatRunStatus,
  ...
  sortSubagentRuns,
} from "../../support/subagents-utils.js";
...
export function registerSubagentsCommands(registry: CommandRegistry): void {
  registry.register("subagents", handleSubagentsCommand);
}
