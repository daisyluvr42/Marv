...
async function loadNodes(cfg: MarvConfig): Promise<NodeSummary[]> {
  try {
...
export function registerPttCommands(registry: CommandRegistry): void {
  registry.register("ptt", handlePTTCommand);
}
