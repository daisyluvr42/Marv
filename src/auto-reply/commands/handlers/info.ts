...
import { buildContextReply } from "./context-report.js";
import { buildExportSessionReply } from "./export-session.js";
...
export function registerInfoCommands(registry: CommandRegistry): void {
  registry.register("help", handleHelpCommand);
  registry.register("commands", handleCommandsListCommand);
  registry.register("status", handleStatusCommand);
  registry.register("context", handleContextCommand);
  registry.register("export-session", handleExportSessionCommand);
  registry.register("whoami", handleWhoamiCommand);
}
