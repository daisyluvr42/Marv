...
import { listThinkingLevels } from "../support/thinking.js";
import { COMMAND_ARG_FORMATTERS } from "./args.js";
import type { ChatCommandDefinition, CommandCategory, CommandScope } from "./types.js";
...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "revert",
      nativeName: "revert",
      description: "Revert workspace to an auto-snapshot.",
      textAlias: "/revert",
      acceptsArgs: true,
      category: "session",
      args: [
        {
          name: "target",
          description: "list, index, or commit hash",
          type: "string",
        },
      ],
    }),
