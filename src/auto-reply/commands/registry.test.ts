...
describe("commands registry", () => {
  ...
  it("exposes native specs", () => {
    ...
    expect(specs.find((spec) => spec.name === "revert")).toBeTruthy();
  });
  ...
  it("detects known text commands", () => {
    ...
    expect(detection.exact.has("/revert")).toBe(true);
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@marv", { botUsername: "marv" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@marv args", {
        botUsername: "marv",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "marv" })).toBe("/help@otherbot");
  });
