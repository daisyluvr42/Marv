...
import { clearInlineDirectives } from "./directives/utils.js";
...
// Import after mocks.
const { handleInlineActions } = await import("./pipeline-inline-actions.js");
...
describe("handleInlineActions", () => {
  it("skips whatsapp replies when config is empty and From !== To", async () => {
    ...
    const result = await handleInlineActions({
      ctx,
      sessionCtx: ctx as unknown as SessionTemplateContext,
      cfg: {},
      agentId: "main",
      sessionKey: "s:main",
      workspaceDir: "/tmp",
