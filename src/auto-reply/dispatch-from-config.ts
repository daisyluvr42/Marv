...
import type { ReplyDispatcher, ReplyDispatchKind } from "./delivery/dispatcher.js";
import { isRoutableChannel, routeReply } from "./delivery/route.js";
import { shouldSkipDuplicateInbound } from "./inbound/dedupe.js";
import { getReplyFromConfig } from "./index.js";
import { formatAbortReplyText, tryFastAbortFromMessage } from "./support/abort.js";
import type { FinalizedTurnContext } from "./support/templating.js";
...
const isInboundAudioContext = (ctx: FinalizedTurnContext): boolean => {
  const rawTypes = [
...
const resolveSessionTtsAuto = (ctx: FinalizedTurnContext, cfg: MarvConfig): string | undefined => {
...
export async function dispatchReplyFromConfig(params: {
  ...
  //
  // Debug: `pnpm test src/auto-reply/dispatch-from-config.test.ts`
