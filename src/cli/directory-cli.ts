    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["marv directory self --channel slack", "Show the connected account identity."],
          [
            'marv directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["marv directory groups list --channel discord", "List available groups/channels."],
          [
            "marv directory groups members --channel discord --group-id <id>",
