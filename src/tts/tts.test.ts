...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.MARV_TTS_PREFS;
      process.env.MARV_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.MARV_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: MarvConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
