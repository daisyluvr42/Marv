...
function isTelegramConfigured(cfg: MarvConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: MarvConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: MarvConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: MarvConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: MarvConfig): boolean {
...
function isIMessageConfigured(cfg: MarvConfig): boolean {
...
function isWhatsAppConfigured(cfg: MarvConfig): boolean {
...
function isGenericChannelConfigured(cfg: MarvConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: MarvConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: MarvConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: MarvConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: MarvConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: MarvConfig, pluginId: string): MarvConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
