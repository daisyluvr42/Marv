...
function resolveAnthropicDefaultAuthMode(cfg: MarvConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MarvConfig): MarvConfig {
...
export function applyTalkApiKey(config: MarvConfig): MarvConfig {
...
export function applyModelDefaults(cfg: MarvConfig): MarvConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MarvConfig): MarvConfig {
...
export function applyLoggingDefaults(cfg: MarvConfig): MarvConfig {
...
export function applyContextPruningDefaults(cfg: MarvConfig): MarvConfig {
...
export function applyCompactionDefaults(cfg: MarvConfig): MarvConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
