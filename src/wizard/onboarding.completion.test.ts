...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("marv");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "marv");
