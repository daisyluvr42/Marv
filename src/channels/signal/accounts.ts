...
import type { SignalAccountConfig } from "../../core/config/types.js";
...
function resolveAccountConfig(cfg: MarvConfig, accountId: string): SignalAccountConfig | undefined {
...
function mergeSignalAccountConfig(cfg: MarvConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MarvConfig): ResolvedSignalAccount[] {
