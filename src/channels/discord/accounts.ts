...
function mergeDiscordAccountConfig(cfg: MarvConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: MarvConfig): ResolvedDiscordAccount[] {
