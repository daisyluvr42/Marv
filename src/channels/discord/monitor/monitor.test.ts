...
describe("agent components", () => {
  const createCfg = (): MarvConfig => ({}) as MarvConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp/marv-sessions-test.json");
  });
