...
function resolveAccountConfig(cfg: MarvConfig, accountId: string): SlackAccountConfig | undefined {
...
function mergeSlackAccountConfig(cfg: MarvConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MarvConfig): ResolvedSlackAccount[] {
