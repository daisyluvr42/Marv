import type { SlackSlashCommandConfig } from "../../../core/config/config.js";
...
export function resolveSlackSlashCommandConfig(
  ...
  const normalizedName = normalizeSlackSlashCommandName(raw?.name?.trim() || "marv");
  const name = normalizedName || "marv";
  return {
