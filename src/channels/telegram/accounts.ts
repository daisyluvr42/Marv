...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MARV_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function mergeTelegramAccountConfig(cfg: MarvConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: MarvConfig): ResolvedTelegramAccount[] {
