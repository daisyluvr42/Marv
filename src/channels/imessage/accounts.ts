...
import type { IMessageAccountConfig } from "../../core/config/types.js";
...
function mergeIMessageAccountConfig(cfg: MarvConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: MarvConfig): ResolvedIMessageAccount[] {
