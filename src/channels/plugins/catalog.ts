...
import { discoverMarvPlugins } from "../../plugins/discovery.js";
import type { MarvPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, MarvPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["MARV_PLUGIN_CATALOG_PATHS", "MARV_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<MarvPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: MarvPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverMarvPlugins({ workspaceDir: options.workspaceDir });
