...
import type { DiscordGuildEntry } from "../../../core/config/types.discord.js";
...
function setDiscordDmPolicy(cfg: MarvConfig, dmPolicy: DmPolicy) {
...
function setDiscordAllowFrom(cfg: MarvConfig, allowFrom: string[]): MarvConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
