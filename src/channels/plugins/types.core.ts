...
export type ChannelAgentToolFactory = (params: { cfg?: MarvConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MarvConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MarvConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MarvConfig }) => boolean;
  supportsCards?: (params: { cfg: MarvConfig }) => boolean;
