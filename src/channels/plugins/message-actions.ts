...
export function listChannelMessageActions(cfg: MarvConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: MarvConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: MarvConfig): boolean {
  for (const plugin of listChannelPlugins()) {
