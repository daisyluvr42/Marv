...
const CONFIG_KEY = Symbol.for("marv:testConfigMock");
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("marv:lastSocket")] = created.lastSocket;
  return created.mod;
});
...
export function resetBaileysMocks() {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("marv:lastSocket")] =
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for("marv:lastSocket")];
  if (typeof getter === "function") {
