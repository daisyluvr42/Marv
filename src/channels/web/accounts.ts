...
export function listWhatsAppAuthDirs(cfg: MarvConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MarvConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MarvConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MarvConfig): ResolvedWhatsAppAccount[] {
