...
export const DEFAULT_BRIDGE_PORT = 4243;
export const DEFAULT_BROWSER_CONTROL_PORT = 4244;
export const DEFAULT_CANVAS_HOST_PORT = 4246;
export const DEFAULT_BROWSER_CDP_PORT_RANGE_START = 4253;
export const DEFAULT_BROWSER_CDP_PORT_RANGE_END = 4352;
