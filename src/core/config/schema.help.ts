...
export const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when Marv writes the config.",
  ...
  "gateway.controlUi.basePath": "Optional URL prefix where the Control UI is served (e.g. /marv).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $MARV_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "tools.web.search.tavily.includeAnswer":
    "Include Tavily's synthesized answer in the response (default: true).",
  ...
  "agents.defaults.memorySearch.sources":
    'Sources to index for legacy file/session recall (default: ["memory"]; add "sessions" to include session transcripts).',
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.marv/memory/{agentId}.sqlite).",
  ...
  "plugins.installs":
    "CLI-managed install metadata (used by `marv plugins update` to locate install sources).",
