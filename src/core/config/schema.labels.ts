...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "update.approval.required": "Require Deploy Approval",
  "update.approval.mode": "Deploy Approval Mode",
  "update.approval.tagPattern": "Deploy Approval Tag Pattern",
  "update.approval.branch": "Deploy Approval Branch",
  "update.approval.requireReachableFromBranch": "Deploy Approval Reachability Check",
  ...
  "agents.defaults.identity.avatar": "Identity Avatar",
  "agents.defaults.skills": "Agent Skill Filter",
  ...
  "agents.defaults.memorySearch.query.precheck.enabled": "Memory Search Precheck Enabled",
  "agents.defaults.memorySearch.query.precheck.rewrite": "Memory Search Query Rewrite",
  "agents.defaults.memorySearch.query.precheck.minQueryChars":
    "Memory Search Precheck Min Query Chars",
  ...
  "agents.defaults.subagents.roles": "Subagent Roles",
  "agents.defaults.subagents.presets": "Subagent Presets",
  "agents.defaults.subagents.defaultPreset": "Default Subagent Preset",
  memory: "Memory",
  "memory.backend": "Memory Backend",
  "memory.citations": "Memory Citations Mode",
  "memory.runtimeIngest": "Runtime Message Ingestion",
  "memory.p0AllowedKinds": "P0 Allowed Kinds",
  "memory.soul": "Soul Memory Tuning",
  "memory.soul.p0AllowedKinds": "P0 Allowed Kinds",
  "memory.soul.forgetConfidenceThreshold": "Forget Confidence Threshold",
  "memory.soul.forgetStreakHalfLives": "Forget Streak Half Lives",
  "memory.soul.p0ClarityHalfLifeDays": "P0 Clarity Half Life (days)",
  "memory.soul.p1ClarityHalfLifeDays": "P1 Clarity Half Life (days)",
  "memory.soul.p2ClarityHalfLifeDays": "P2 Clarity Half Life (days)",
  "memory.soul.p3ClarityHalfLifeDays": "P3 Clarity Half Life (days)",
  "memory.soul.p0RecallRelevanceThreshold": "P0 Recall Relevance Threshold",
  "memory.soul.p2ToP1MinClarity": "P2 To P1 Min Clarity",
  "memory.soul.p2ToP1MinAgeDays": "P2 To P1 Min Age (days)",
  "memory.soul.p2ToP1MinScopeCount": "P2 To P1 Min Scope Count",
  "memory.soul.p1ToP0MinClarity": "P1 To P0 Min Clarity",
  "memory.soul.p1ToP0MinAgeDays": "P1 To P0 Min Age (days)",
  "memory.soul.p0ScopePenalty": "P0 Scope Penalty",
  "memory.soul.crossScopePenalty": "Cross Scope Penalty",
  "memory.soul.matchScopePenalty": "Match Scope Penalty",
  "memory.soul.p0TierMultiplier": "P0 Tier Multiplier",
  "memory.soul.p1TierMultiplier": "P1 Tier Multiplier",
  "memory.soul.p2TierMultiplier": "P2 Tier Multiplier",
  "memory.soul.p3TierMultiplier": "P3 Tier Multiplier",
  "memory.soul.scoreSimilarityWeight": "Similarity Score Weight",
  "memory.soul.scoreDecayWeight": "Decay Score Weight",
  "memory.soul.reinforcementLogWeight": "Reinforcement Log Weight",
  "memory.soul.referenceExpansionEnabled": "Reference Expansion Enabled",
  "memory.soul.referenceMaxHops": "Reference Max Hops",
  "memory.soul.referenceEdgeDecay": "Reference Edge Decay",
  "memory.soul.referenceBoostWeight": "Reference Boost Weight",
  "memory.soul.referenceMaxBoost": "Reference Max Boost",
  "memory.soul.referenceSeedTopKMultiplier": "Reference Seed TopK Multiplier",
  "memory.soul.deepConsolidation": "Deep Memory Consolidation",
  "memory.soul.deepConsolidation.enabled": "Deep Consolidation Enabled",
  "memory.soul.deepConsolidation.schedule": "Deep Consolidation Schedule",
  "memory.soul.deepConsolidation.maxItems": "Deep Consolidation Max Items",
  "memory.soul.deepConsolidation.maxReflections": "Deep Consolidation Max Reflections",
  "memory.soul.deepConsolidation.clusterSummarization": "Deep Cluster Summarization",
  "memory.soul.deepConsolidation.conflictJudgment": "Deep Conflict Judgment",
  "memory.soul.deepConsolidation.crossScopeReflection": "Deep Cross Scope Reflection",
  "memory.soul.deepConsolidation.model.provider": "Deep Consolidation Model Provider",
  "memory.soul.deepConsolidation.model.api": "Deep Consolidation Model API",
  "memory.soul.deepConsolidation.model.model": "Deep Consolidation Model",
  "memory.soul.deepConsolidation.model.baseUrl": "Deep Consolidation Base URL",
  "memory.soul.deepConsolidation.model.timeoutMs": "Deep Consolidation Timeout (ms)",
  ...
  "autonomy.skills": "Autonomy Skills Strategy",
  "autonomy.toolProfile": "Autonomy Tool Profile",
  "autonomy.autoInstallSkills": "Auto-Install Skills",
  "autonomy.escalation.enabled": "Permission Escalation",
  "autonomy.escalation.taskScoped": "Escalation Task-Scoped",
  "autonomy.escalation.approvalTimeoutSeconds": "Escalation Approval Timeout (sec)",
  "autonomy.discovery.enabled": "Tool Discovery",
  "autonomy.discovery.scope": "Tool Discovery Scope",
  "autonomy.discovery.installApproval": "Tool Discovery Install Approval",
  "autonomy.privacy.enabled": "Privacy Guard",
  "autonomy.privacy.categories": "Privacy Guard Categories",
  "autonomy.privacy.outputScan": "Privacy Output Scan",
  ...
  "agents.defaults.modelPool": "Default Model Pool",
  "agents.modelPools": "Model Pools",
