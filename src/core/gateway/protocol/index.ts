...
import {
  ...
  type ConfigPatchesCommitParams,
  ConfigPatchesCommitParamsSchema,
  type ConfigPatchesProposeParams,
  ConfigPatchesProposeParamsSchema,
  type ConfigPatchParams,
  ConfigPatchParamsSchema,
  type ConfigRevisionsListParams,
  ConfigRevisionsListParamsSchema,
  type ConfigRevisionsRollbackParams,
...
export const validateMemoryListParams = ajv.compile<MemoryListParams>(MemoryListParamsSchema);
export const validateMemorySearchParams = ajv.compile<MemorySearchParams>(MemorySearchParamsSchema);
export const validateDocumentsListParams =
  ajv.compile<DocumentsListParams>(DocumentsListParamsSchema);
export const validateDocumentsReadParams =
  ajv.compile<DocumentsReadParams>(DocumentsReadParamsSchema);
...
export const validateConfigPatchesProposeParams = ajv.compile<ConfigPatchesProposeParams>(
  ConfigPatchesProposeParamsSchema,
);
export const validateConfigPatchesCommitParams = ajv.compile<ConfigPatchesCommitParams>(
  ConfigPatchesCommitParamsSchema,
);
export const validateConfigRevisionsRollbackParams = ajv.compile<ConfigRevisionsRollbackParams>(
  ConfigRevisionsRollbackParamsSchema,
);
export const validateConfigRevisionsListParams = ajv.compile<ConfigRevisionsListParams>(
  ConfigRevisionsListParamsSchema,
);
...
export const validateLedgerEventsQueryParams = ajv.compile<LedgerEventsQueryParams>(
  LedgerEventsQueryParamsSchema,
);
