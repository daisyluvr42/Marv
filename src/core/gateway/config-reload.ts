...
import type { MarvConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export type GatewayReloadPlan = {
  ...
  hotReasons: string[];
  reloadHooks: boolean;
  reloadModelAvailability: boolean;
...
const BASE_RELOAD_RULES: ReloadRule[] = [
  ...
  },
  {
    ...
    kind: "hot",
    actions: ["reload-model-availability"],
  },
];
...
export function resolveGatewayReloadSettings(cfg: MarvConfig): GatewayReloadSettings {
  ...
  const applyAction = (action: ReloadAction) => {
    ...
    switch (action) {
      case "reload-hooks":
        ...
        break;
      case "reload-model-availability":
        plan.reloadModelAvailability = true;
        break;
...
export function startGatewayConfigReloader(opts: {
  initialConfig: MarvConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: MarvConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: MarvConfig) => void;
  log: {
