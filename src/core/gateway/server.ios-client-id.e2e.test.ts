...
beforeAll(async () => {
  previousToken = process.env.MARV_GATEWAY_TOKEN;
  process.env.MARV_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "marv-ios", platform: "ios" },
  { clientId: "marv-android", platform: "android" },
