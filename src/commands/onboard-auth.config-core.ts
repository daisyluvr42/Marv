...
export function applyOpenrouterConfig(cfg: MarvConfig): MarvConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: MarvConfig): MarvConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: MarvConfig): MarvConfig {
...
export function applyMoonshotConfig(cfg: MarvConfig): MarvConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: MarvConfig): MarvConfig {
...
export function applyKimiCodeConfig(cfg: MarvConfig): MarvConfig {
...
export function applyXiaomiConfig(cfg: MarvConfig): MarvConfig {
 ...
 */
export function applyVeniceConfig(cfg: MarvConfig): MarvConfig {
 ...
 */
export function applyTogetherConfig(cfg: MarvConfig): MarvConfig {
 ...
 */
export function applyHuggingfaceConfig(cfg: MarvConfig): MarvConfig {
...
export function applyXaiConfig(cfg: MarvConfig): MarvConfig {
