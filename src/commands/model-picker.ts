...
import { OPENAI_CODEX_DEFAULT_MODEL } from "./onboard-auth.constants.js";
...
type PromptDefaultModelResult = { model?: string; config?: MarvConfig };
...
function resolveConfiguredModelRaw(cfg: MarvConfig): string {
