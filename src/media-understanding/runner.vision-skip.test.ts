...
vi.mock("../agents/model/model-catalog.js", async () => {
  const actual = await vi.importActual<typeof import("../agents/model/model-catalog.js")>(
    "../agents/model/model-catalog.js",
  );
  return {
    ...actual,
