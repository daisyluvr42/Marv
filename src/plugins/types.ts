...
export type MarvPluginConfigSchema = {
...
export type MarvPluginToolContext = {
  config?: MarvConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type MarvPluginToolFactory = (
  ctx: MarvPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type MarvPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<MarvConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type MarvPluginGatewayMethod = {
  method: string;
 ...
 */
export type MarvPluginCommandDefinition = {
...
export type MarvPluginCliContext = {
  program: Command;
  config: MarvConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type MarvPluginCliRegistrar = (ctx: MarvPluginCliContext) => void | Promise<void>;

export type MarvPluginServiceContext = {
  config: MarvConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type MarvPluginService = {
  id: string;
  start: (ctx: MarvPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: MarvPluginServiceContext) => void | Promise<void>;
};

export type MarvPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type MarvPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: MarvPluginConfigSchema;
  register?: (api: MarvPluginApi) => void | Promise<void>;
  activate?: (api: MarvPluginApi) => void | Promise<void>;
};

export type MarvPluginModule =
  | MarvPluginDefinition
  | ((api: MarvPluginApi) => void | Promise<void>);

export type MarvPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  registerCli: (registrar: MarvPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: MarvPluginService) => void;
   ...
   */
  registerCommand: (command: MarvPluginCommandDefinition) => void;
