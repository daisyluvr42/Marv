...
import {
  ...
  LEGACY_OPENCLAW_BROWSER_PROFILE_NAME,
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_MARV_BROWSER_PROFILE_NAME] && !result[LEGACY_OPENCLAW_BROWSER_PROFILE_NAME]) {
...
function ensureDefaultChromeExtensionProfile(
  ...
  // (legacy single-profile configs may use controlPort+1 for marv/openclaw CDP).
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ...
      : profiles[DEFAULT_MARV_BROWSER_PROFILE_NAME]
        ? DEFAULT_MARV_BROWSER_PROFILE_NAME
        : profiles[LEGACY_OPENCLAW_BROWSER_PROFILE_NAME]
          ? LEGACY_OPENCLAW_BROWSER_PROFILE_NAME
          : DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME);
