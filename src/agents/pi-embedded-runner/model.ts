...
import {
  ...
  type AuthStorage,
  type ModelRegistry,
} from "../model/pi-model-discovery.js";
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveMarvAgentDir();
 ...
 * Users often put `ollama/...` first in their active model pool but
...
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    ...
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "marv configure". ' +
    "See: /providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "marv configure". ' +
    "See: /providers/vllm",
};
