...
function resolveWatchPaths(workspaceDir: string, config?: MarvConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MarvConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MarvConfig }) {
