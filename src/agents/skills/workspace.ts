...
function resolveSkillsLimits(config?: MarvConfig): ResolvedSkillsLimits {
...
function applySkillsPromptLimits(params: { skills: Skill[]; config?: MarvConfig }): {
