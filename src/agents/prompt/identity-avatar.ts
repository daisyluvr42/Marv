...
function resolveAvatarSource(cfg: MarvConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MarvConfig, agentId: string): AgentAvatarResolution {
