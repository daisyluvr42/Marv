...
export function resolveAgentIdentity(cfg: MarvConfig, agentId: string): IdentityConfig | undefined {
...
export function resolveIdentityNamePrefix(cfg: MarvConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[marv]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: MarvConfig, channel: string): Record<string, unknown> | undefined {
