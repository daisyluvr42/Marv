...
import type { ModelProviderAuthMode, ModelProviderConfig } from "../../core/config/types.js";
...
import { normalizeProviderId } from "./model-ref.js";
...
export async function resolveApiKeyForProvider(params: {
  ...
  throw new Error(
    [
      ...
      `Configure auth for this agent (${formatCliCommand("marv agents add <id>")}) or copy auth-profiles.json from the main agentDir.`,
    ].join(" "),
  );
}
