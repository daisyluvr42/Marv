...
import { extractToolCallsFromAssistant, extractToolResultId } from "./tools/meta/tool-call-id.js";
...
function makeMissingToolResult(params: {
  ...
  return {
    ...
    content: [
      {
        type: "text",
        text: "[marv] missing tool result in session history; inserted synthetic error result for transcript repair.",
      },
    ],
    isError: true,
    timestamp: Date.now(),
