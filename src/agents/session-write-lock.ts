...
const CLEANUP_STATE_KEY = Symbol.for("marv.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("marv.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("marv.sessionWriteLockWatchdogState");
