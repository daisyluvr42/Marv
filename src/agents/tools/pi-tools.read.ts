...
function resolveAdaptiveReadMaxBytes(options?: MarvReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMarvReadTool(base, {
...
export function createMarvReadTool(
  base: AnyAgentTool,
  options?: MarvReadToolOptions,
): AnyAgentTool {
