...
describe("createMarvCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createMarvCodingTools({
      config,
    ...
    const anthropicTools = createMarvCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createMarvCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createMarvCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
