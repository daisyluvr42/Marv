...
async function sendEmail(options) {
  ...
  try {
    ...
    throw new Error(`SMTP connection failed: ${err.message}`, { cause: err });
  }
...
async function testConnection() {
  ...
  try {
    ...
    throw new Error(`SMTP test failed: ${err.message}`, { cause: err });
  }
}
...
async function verifyConnection() {
  ...
  try {
    ...
    throw new Error(`SMTP verify failed: ${err.message}`, { cause: err });
  }
}
