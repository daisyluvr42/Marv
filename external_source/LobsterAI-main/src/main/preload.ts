...
contextBridge.exposeInMainWorld("electron", {
  ...
  im: {
    ...
    // Gateway control
    startGateway: (platform: "dingtalk" | "feishu" | "telegram" | "discord") =>
      ipcRenderer.invoke("im:gateway:start", platform),
    stopGateway: (platform: "dingtalk" | "feishu" | "telegram" | "discord") =>
      ipcRenderer.invoke("im:gateway:stop", platform),
    testGateway: (platform: "dingtalk" | "feishu" | "telegram" | "discord", configOverride?: any) =>
  ...
  scheduledTasks: {
    ...
    toggle: (id: string, enabled: boolean) =>
      ipcRenderer.invoke("scheduledTask:toggle", id, enabled),
