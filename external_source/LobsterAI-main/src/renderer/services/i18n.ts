...
const translations: Record<LanguageType, Record<string, string>> = {
  ...
  en: {
    ...
    coworkExecutionModeAutoHint:
      "Prefer the built-in VM sandbox when available, otherwise run locally",
    ...
    coworkMemorySimpleHint:
      "For most users, keep this on and manage entries below. No extra tuning needed.",
    ...
    coworkSandboxManualInstallNotice:
      "You are currently running outside Sandbox mode. Install sandbox components manually to enable sandbox execution.",
