    ...
    @Test func discoversBeaconFromTailnetDnsSdFallback() {
        ...
        let context = WideAreaGatewayDiscovery.DiscoveryContext(
            ...
            dig: { args, _ in
                ...
                if recordType == "SRV" {
                    return "0 0 4242 steipetacstudio.openclaw.internal."
                }
                if recordType == "TXT" {
                    return "\"displayName=Peter\\226\\128\\153s Mac Studio (OpenClaw)\" \"gatewayPort=4242\" \"tailnetDns=peters-mac-studio-1.sheep-coho.ts.net\" \"cliPath=/Users/steipete/openclaw/src/entry.ts\""
                }
                return ""
            })
