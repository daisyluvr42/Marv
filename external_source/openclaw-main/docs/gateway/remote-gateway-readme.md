...
OpenClaw.app connects to `ws://127.0.0.1:4242` on your client machine. The SSH tunnel forwards that connection to port 4242 on the remote machine where the Gateway is running.
