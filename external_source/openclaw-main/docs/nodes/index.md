...
```bash
openclaw node run --host <gateway-host> --port 4242 --display-name "Build Node"
```
...
openclaw node run --host 127.0.0.1 --port 4243 --display-name "Build Node"
```
...
```bash
openclaw node install --host <gateway-host> --port 4242 --display-name "Build Node"
...
```bash
openclaw node run --host <gateway-host> --port 4242
```
