...
```
http://<tailscale-hostname>:4246/__openclaw__/canvas/<file>.html
```
...
- **loopback**: `http://127.0.0.1:4246/__openclaw__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:4246/__openclaw__/canvas/<file>.html`
...
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:4246/__openclaw__/canvas/snake.html
```
...
3. Test URL directly: `curl http://<hostname>:4246/__openclaw__/canvas/<file>.html`
...
```
http://<host>:4246/__openclaw__/canvas/index.html  → ~/clawd/canvas/index.html
http://<host>:4246/__openclaw__/canvas/games/snake.html → ~/clawd/canvas/games/snake.html
```
