        ...
        },
        {
          ...
          cfg: {
            gateway: {
              ...
              remote: { url: "wss://remote.example.com:4242", token: "remote-token-xyz789" },
            },
          },
        ...
        },
        {
          ...
          cfg: {
            gateway: {
              mode: "remote",
              auth: { token: "local-token-should-not-use" },
              remote: { url: "wss://remote.example.com:4242", token: "remote-token" },
            },
          },
          env: { token: "env-token" },
      ...
      const cases: Array<{
      ...
      }> = [
        {
          ...
          cfg: {
            gateway: {
              mode: "remote",
              remote: { url: "wss://remote.example.com:4242", password: "remote-pass" },
            },
          },
